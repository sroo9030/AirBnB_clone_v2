...
7. /number_odd_or_even/<n>: displays a HTML page only if n is an integer,
   with an H1 tag “Number: n is even|odd” inside the tag BODY.
"""
...
def number_odd_or_even(n):
    ...
    return render_template('number_odd_or_even.html', result=result)
